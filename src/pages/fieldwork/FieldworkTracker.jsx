      ...
      <div className="bg-navy-900 border border-navy-600 rounded-2xl w-full max-w-lg">
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div><label className="block text-xs text-steel-400 mb-1">Standard</label><select className="input-field" value={form.standard} onChange={e => setForm(p => ({ ...p, standard: e.target.value }))}>{['ISO 27001', 'ISO 27002', 'ISO 27005', 'ISO 9001', 'ISO 19011', 'IMS'].map(s => <option key={s}>{s}</option>)}</select></div>

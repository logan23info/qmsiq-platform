...
export default function DocumentRegister() {
  ...
  const { priorContext, priorLoading } = useQMSContext('ISO 9001:2015 Cl.7.5', activeProgramme?.id)
  ...
  return (
    <div className="max-w-4xl">
      ...
      {canEdit && <QMSAIGenerator clause="ISO 9001:2015 Cl.7.5" systemPrompt={SYSTEM_PROMPT} requiredFields={REQUIRED} placeholder="Describe your organisation — industry, size, products/services, any existing documents..." onGenerated={onGenerated} priorContext={priorContext} />}
      {showForm && (
